---
title: "Mapping the Emotional Dimension: Measuring Cyclists' Physiological Responses Across Space and Time"
author: "G. C. Millar"
...
```{r setup, tidy=TRUE, message=FALSE, warning=FALSE, cache=TRUE, include=FALSE}
library(sp)
library(raster)
library(R.matlab)
library(plyr)
...
```{r Data Setup & Manipulation a, tidy=TRUE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r Data Setup & Manipulation b, tidy=TRUE, message=FALSE, warning=FALSE, cache=TRUE, include=FALSE, echo=FALSE}
